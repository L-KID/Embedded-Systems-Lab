...
;* Date/Time created: Mon May 15 14:45:00 2017                                *
;******************************************************************************
...
;	/data/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/308115fytmI /tmp/30811D0Q3KO 
	.sect	".text"
	.clink
	.global	_sum_dsp
...
$C$DW$45	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$45, DW_AT_name("/data/home/in4342-10/RajanA2DSP/dsp/task.asm:$C$L3:1:1494859500")
...
$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("/data/home/in4342-10/RajanA2DSP/dsp/task.asm:$C$L1:1:1494859500")
...
$C$DW$61	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$61, DW_AT_name("/data/home/in4342-10/RajanA2DSP/dsp/task.asm:$C$L9:1:1494859500")
...
$C$DW$63	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$63, DW_AT_name("/data/home/in4342-10/RajanA2DSP/dsp/task.asm:$C$L7:1:1494859500")
