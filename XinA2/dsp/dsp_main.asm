...
;* Date/Time created: Tue Jun  6 21:50:03 2017                                *
;******************************************************************************
...
;	/data/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/09872tmYjGR /tmp/09872h1boIg 
	.sect	".text"
	.clink
	.global	_main
...
$C$DW$16	.dwtag  DW_TAG_subprogram, DW_AT_name("main")
	...
	.dwpsn	file "dsp_main.c",line 308,column 1,is_stmt,address _main
...
;          EXCLUSIVE CPU CYCLES: 9
           MVKL    .S1     _DSPLINK_init,A3  ; |311| 
           MVKH    .S1     _DSPLINK_init,A3  ; |311| 
           STW     .D2T2   B11,*SP--(16)     ; |308| 
$C$DW$19	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$19, DW_AT_TI_call
           CALL    .S2X    A3                ; |311| 
           MV      .L2     B3,B11            ; |308| 
           STW     .D2T2   B10,*+SP(12)      ; |308| 
           MV      .L2     B4,B10            ; |308| 
           ADDKPC  .S2     $C$RL0,B3,1       ; |311| 
$C$RL0:    ; CALL OCCURS {_DSPLINK_init} {0}  ; |311| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 18
           MVKL    .S1     _atoi,A3          ; |314| 
           MVKH    .S1     _atoi,A3          ; |314| 
           LDW     .D2T1   *B10,A4           ; |314| 
$C$DW$20	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$20, DW_AT_TI_call
           CALL    .S2X    A3                ; |314| 
           ADDKPC  .S2     $C$RL1,B3,4       ; |314| 
$C$RL1:    ; CALL OCCURS {_atoi} {0}         ; |314| 

           ZERO    .L2     B4                ; |317| 
||         MVK     .S1     127,A3            ; |314| 

           STW     .D2T2   B4,*+SP(8)        ; |317| 
||         MVKL    .S2     _TSK_create,B4    ; |317| 
||         ADD     .L1     A3,A4,A3          ; |314| 

           MVKH    .S2     _TSK_create,B4    ; |317| 
||         SHR     .S1     A3,6,A4           ; |314| 
...
||         MVKL    .S1     _Task,A4          ; |317| 
||         MVKH    .S2     _MPCSXFER_BufferSize,B5

           STH     .D2T1   A3,*B5            ; |314| 
||         MVKH    .S1     _Task,A4          ; |317| 
||         ADDKPC  .S2     $C$RL2,B3,0       ; |317| 

$C$RL2:    ; CALL OCCURS {_TSK_create} {0}   ; |317| 
;** --------------------------------------------------------------------------*
...
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$22, DW_AT_TI_return
           ...
           RET     .S2     B3                ; |318| 
||         LDW     .D2T2   *+SP(12),B10      ; |318| 

           LDW     .D2T2   *++SP(16),B11     ; |318| 
	.dwpsn	file "dsp_main.c",line 318,column 1,is_stmt
           NOP             4
           ; BRANCH OCCURS {B3}              ; |318| 
	.dwattr $C$DW$16, DW_AT_TI_end_file("dsp_main.c")
	.dwattr $C$DW$16, DW_AT_TI_end_line(0x13e)
...
;          EXCLUSIVE CPU CYCLES: 8
           MVKL    .S2     _Task_create,B4   ; |335| 
           MVKH    .S2     _Task_create,B4   ; |335| 
$C$DW$24	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$24, DW_AT_low_pc(0x00)
	.dwattr $C$DW$24, DW_AT_name("_Task_create")
	.dwattr $C$DW$24, DW_AT_TI_call
           CALL    .S2     B4                ; |335| 
           STW     .D2T2   B3,*SP--(8)       ; |330| 
           ADDKPC  .S2     $C$RL3,B3,2       ; |335| 
           ADD     .L1X    4,SP,A4           ; |335| 
$C$RL3:    ; CALL OCCURS {_Task_create} {0}  ; |335| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 8

           MV      .L1     A4,A0             ; |335| 
||         MVKL    .S1     _Task_execute,A3  ; |340| 
||         LDW     .D2T1   *+SP(4),A4        ; |340| 

   [ A0]   MVKL    .S2     _Task_delete,B4   ; |348| 
||         MVKH    .S1     _Task_execute,A3  ; |340| 
|| [ A0]   LDW     .D2T1   *+SP(4),A4        ; |348| 

   [ A0]   MVKH    .S2     _Task_delete,B4   ; |348| 
|| [ A0]   B       .S1     $C$L1             ; |335| 
...
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 9
           ADDKPC  .S2     $C$RL4,B3,1       ; |340| 
$C$RL4:    ; CALL OCCURS {_Task_execute} {0}  ; |340| 
           MVKL    .S2     _Task_delete,B4   ; |348| 
           MVKH    .S2     _Task_delete,B4   ; |348| 
$C$DW$27	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$27, DW_AT_low_pc(0x00)
	.dwattr $C$DW$27, DW_AT_name("_Task_delete")
	.dwattr $C$DW$27, DW_AT_TI_call
           CALL    .S2     B4                ; |348| 
           LDW     .D2T1   *+SP(4),A4        ; |348| 
           NOP             3
;** --------------------------------------------------------------------------*
$C$L1:    
;          EXCLUSIVE CPU CYCLES: 1
           ADDKPC  .S2     $C$RL5,B3,0       ; |348| 
$C$RL5:    ; CALL OCCURS {_Task_delete} {0}  ; |348| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 11
           LDW     .D2T2   *++SP(8),B3       ; |355| 
           NOP             4
	.dwpsn	file "dsp_main.c",line 355,column 1,is_stmt
$C$DW$28	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$28, DW_AT_low_pc(0x00)
	.dwattr $C$DW$28, DW_AT_TI_return
           RETNOP  .S2     B3,5              ; |355| 
           ; BRANCH OCCURS {B3}              ; |355| 
	.dwattr $C$DW$23, DW_AT_TI_end_file("dsp_main.c")
	.dwattr $C$DW$23, DW_AT_TI_end_line(0x163)
